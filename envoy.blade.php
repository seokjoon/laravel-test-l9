...
@setup
  $username = 'dp';                     // 서버의 사용자 계정
  $remote = 'git@bitbucket.org:seokjoonlee/l9.git';  // 깃허브 저장소 주소
  $base_dir = "/d1/docker/inst/ec17/www/html/l/l9";        // 웹서비스를 담을 기본 디렉터리
  $project_root = "{$base_dir}/root";        // 프로젝트 루트 디렉터리
